...
const Scoring = () => {
  return (
       <div className="flex flex-col z-20 items-center justify-center">
                    ...
                    <h3 className="text-4xl font-semibold pt-8  text-orange-700">Scoring system</h3>
                    <p className="text-2xl text-muted-foreground font-semibold capitalize">only the best result counts</p>
