...
const Scoring = () => {
  return (
       <div className="flex flex-col z-20 items-center justify-center">
                    ...
                    <h3 className="text-3xl xl:text-4xl font-semibold pt-3  text-orange-700">Scoring system</h3>
                    <p className="text-xl text-gray-800 font-semibold capitalize">only the best result counts</p>
